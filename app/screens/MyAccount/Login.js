...
export default class Login extends Component {
  ...
  login = () => {
    ...
    if (!validate)
      this.setState({ loginErrorMessage: "Los datos del formulario erroneos" });
    else {
      ...
      firebase
        ...
        .then(() =>
          this.refs.toast.show("Login Correcto ", 500, () => {
      ...
      <View style={styles.viewBody}>
        ...
        <View style={styles.viewFrom}>
          ...
          <Button
            ...
            onPress={() => this.login()}
          />
          <Text style={styles.textRegister}>¿Aun no tienes cuenta? </Text>
          <Text
